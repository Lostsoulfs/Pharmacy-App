...
| `red_flags` | UNVERIFIED | Quiz training, safety prompts | SRC-PTCB-2026-PTCE, SRC-FDA-DRUG-SAFETY, SRC-DEA-PHARMACIST-MANUAL | Medications; Patient Safety and Quality Assurance; Federal Requirements | Item-level metadata added in `docs/audits/red_flags_item_metadata_2026-06-17.md`; scenario text still needs qualified review. |

...
| `lasa_pairs` | UNVERIFIED | Quiz training | SRC-PTCB-2026-PTCE, SRC-PTCB-2026-KNOWLEDGE | Patient Safety and Quality Assurance; Medications | Confirm each look-alike/sound-alike pair is appropriate for technician training. |
| `sig_abbreviations` | UNVERIFIED | SIG decoder | SRC-PTCB-2026-PTCE, SRC-PTCB-2026-KNOWLEDGE | Order Entry and Processing | Confirm abbreviations and meanings against a qualified training source before expanding entries. |
| `common_rx_flags` | UNVERIFIED | Drug lookup, warning notes | SRC-PTCB-2026-PTCE, SRC-FDA-DRUG-SAFETY | Medications; Patient Safety and Quality Assurance | Source-map each warning and keep high-risk items framed as pharmacist-review prompts. |
